...
def map_native_country(country):
    ...
    # Developed Countries
    if country in ['England', 'Canada', 'Germany', 'Japan', 'Poland', 'China', 
                   'Italy', 'Mexico', 'Portugal', 'Ireland', 'France', 
                   'Holand-Netherlands', 'Greece', 'Hungary', 'Scotland']:
        return 1
    # Underdeveloped Countries
    if country in ['Cambodia', 'Puerto-Rico', 'Outlying-US(Guam-USVI-etc)', 'India',
                   'South', 'Cuba', 'Iran', 'Honduras', 'Philippines', 'Jamaica', 
                   'Vietnam', 'Dominican-Republic', 'Laos', 'Ecuador', 'Taiwan', 
                   'Haiti', 'Columbia', 'Nicaragua', 'Thailand', 'Peru', 'Hong', 
                   'Trinadad&Tobago', 'Guatemala', 'Yugoslavia', 'El-Salvador']:
        return 2
